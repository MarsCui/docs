...
| --- | --- | --- | --- | --- |
| 指标名称 | 必填 | 文本 | `GPU` | 规格指标展示名称。 |
| 资源键 | 必填 | 文本 | `nvidia.com/gpu` | 调度使用的资源键。 |
| 单位 | 必填 | 文本 | `card` | 指标计量单位。 |
| 显示顺序 | 否 | 数字 | `10` | 页面展示顺序。 |
| 状态 | 必填 | 枚举 | `启用` | 是否允许规格引用。 |
#### 踩坑提示
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 指标出现在列表中 | 指标出现在列表中。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 资源规格创建页可选择该指标 | 资源规格创建页可选择该指标。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 测试作业能按该指标申请资源 | 测试作业能按该指标申请资源。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
