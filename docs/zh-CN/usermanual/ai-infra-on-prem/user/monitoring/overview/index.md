...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 总览卡片显示时间范围、地域、集群 | 总览卡片显示时间范围、地域、集群数和异常数量。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 切换时间范围后 | 切换时间范围后，趋势图或异常数量同步变化。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 下钻到集群、节点、设备或作业页后 | 下钻到集群、节点、设备或作业页后，对象范围与总览一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
