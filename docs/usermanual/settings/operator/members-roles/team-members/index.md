...
`Team Members` is used to view, filter, and maintain team members information. It helps operator admin work with team members records and related status from a consistent page entry.

| Item | Content |
| --- | --- |
| Applicable role | Operator admin |
| Navigation path | Members & Roles > Team Members |
| Page route | /operator/members-roles/team-members |
| Managed objects | Team Members records and related status |
| Typical use | View, filter, and maintain team members information |
...
The following screenshot shows team members.

![Team Members](./images/team-members-list.png)
...
The expected result is not visible on the `Team Members` page, or the available action does not match the current business expectation.
...
- The action may be restricted because it affects team members records and related status.

**Handling:**

1. Reset filters and search again from `Members & Roles > Team Members`.
