...
`Customer Top-up Orders` is used to view, filter, and maintain customer top-up orders information. It helps platform operator, billing operator work with customer top-up orders records and related status from a consistent page entry.

| Item | Content |
| --- | --- |
| Applicable role | Platform operator, billing operator |
| Navigation path | Customer Billing > Customer Top-up Orders |
| Page route | /billing/customers/top-ups/orders |
| Managed objects | Customer Top-up Orders records and related status |
| Typical use | View, filter, and maintain customer top-up orders information |

### Beginner Explanation

Customer Top-up Orders is part of the billing control loop. Treat it as a view for confirming money, quota, billing-cycle, customer, or settlement status before making financial decisions.
...
The page usually includes filters, summary cards, data tables, detail entries, status fields, and related operation buttons for customer top-up orders records and related status.
...
The following screenshot shows customer top-up orders list.

![Customer Top-up Orders list](./images/top-up-orders-list.png)

## Main Operations

Use the following operations to work with customer top-up orders records and related status. Complete view-only checks before opening dialogs that may create, save, submit, activate, transfer, settle, publish, or delete data.

### View Top-up Orders

1. Go to `Customer Billing > Customer Top-up Orders`.
2. Use filters or tabs to locate the target record.
3. Select the target row or entry related to customer top-up orders records and related status.
...
The expected result is not visible on the `Customer Top-up Orders` page, or the available action does not match the current business expectation.
...
- The action may be restricted because it affects customer top-up orders records and related status.

**Handling:**

1. Reset filters and search again from `Customer Billing > Customer Top-up Orders`.
...
### Customer Top-up Orders Troubleshooting
