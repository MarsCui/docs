...
| --- | --- | --- | --- | --- |
| 节点名 | 必填 | 文本 | `node-gpu-01` | 定位具体计算节点。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 节点列表展示节点名、状态和关键资 | 节点列表展示节点名、状态和关键资源指标。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 节点状态能与集群健康和作业调度结 | 节点状态能与集群健康和作业调度结果对应。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 指标更新时间能说明采集是否延迟 | 指标更新时间能说明采集是否延迟。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
