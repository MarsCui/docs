...
| --- | --- | --- | --- | --- |
| Prompt | 必填 | 多行文本 | `请总结这段文本` | 输入给模型的提示词。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 页面返回与 Prompt 相关的 | 页面返回与 Prompt 相关的文本回答。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 调整 Temperature、T | 调整 Temperature、Top-P 或 Max Tokens 后，输出长度和风格变化符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| Stream 开关状态与返回方式 | Stream 开关状态与返回方式一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
## 常见问题
