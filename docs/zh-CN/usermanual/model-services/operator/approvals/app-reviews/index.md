...
| 应用名称 | 必填 | 文本 | `智能客服应用` | 申请发布的应用。 |
| 绑定模型 | 必填 | 文本 | `qwen-plus` | 应用调用的模型。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 审核单状态更新为通过、驳回或需补 | 审核单状态更新为通过、驳回或需补正。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 通过后应用进入发布列表 | 通过后应用进入发布列表。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 目标客户能按可见范围看到应用 | 目标客户能按可见范围看到应用。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
## 常见问题
