...
1. 进入 `运营财务 > 调账处理`。
2. 阅读页面顶部风险提示。
3. 在 `查找需要调账的计费记录` 输入框中输入目标记录线索。
4. 点击 `评估影响`。
5. 查看系统预览的关联账务分录和影响范围。

### 查看调账记录

1. 在 `调账记录` 列表中查看已有调账记录。
2. 按时间、主体/账户、方向、金额、原因和操作人核对记录。
3. 点击 `详情` 查看单条调账记录的更多信息。
