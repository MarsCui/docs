...
`Customers` is used to view, filter, and maintain customers information. It helps provider account, provider finance viewer work with customers records and related status from a consistent page entry.

| Item | Content |
| --- | --- |
| Applicable role | Provider account, provider finance viewer |
| Navigation path | Earnings > Customers |
| Page route | /user/earnings/customers |
| Managed objects | Customers records and related status |
| Typical use | View, filter, and maintain customers information |

### Beginner Explanation

Customers is part of the billing control loop. Treat it as a view for confirming money, quota, billing-cycle, customer, or settlement status before making financial decisions.
...
1. The current account can access `Earnings > Customers`.
...
The page usually includes filters, summary cards, data tables, detail entries, status fields, and related operation buttons for customers records and related status.
...
The following screenshot shows customers.

![Customers](./images/customers-list.png)

## Main Operations

Use the following operations to work with customers records and related status. Complete view-only checks before opening dialogs that may create, save, submit, activate, transfer, settle, publish, or delete data.

### Query Customer Earnings

1. Go to `Earnings > Customers`.
2. Use filters or tabs to locate the target record.
3. Select the target row or entry related to customers records and related status.
4. Click the visible `Search Customer Earnings` entry when it is available.
...
2. Use filters or tabs to locate the target record.
3. Select the target row or entry related to customers records and related status.
4. Click the visible `Filter Customers by Tag` entry when it is available.
5. Check the displayed details, status, and related fields before moving to the next page.
...
2. Use filters or tabs to locate the target record.
3. Select the target row or entry related to customers records and related status.
4. Click the visible `View Customer Details` entry when it is available.
5. Check the displayed details, status, and related fields before moving to the next page.
...
2. Use filters or tabs to locate the target record.
3. Select the target row or entry related to customers records and related status.
4. Click the visible `Manage Customer Tags` entry when it is available.
...
| --- | --- | --- |
| Page access | The `Earnings > Customers` page opens and data loads normally. | Check role permissions and refresh the page. |
...
The expected result is not visible on the `Customers` page, or the available action does not match the current business expectation.
...
- The action may be restricted because it affects customers records and related status.

**Handling:**

1. Reset filters and search again from `Earnings > Customers`.
