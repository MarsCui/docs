...
| --- | --- | --- | --- | --- |
| 加速卡厂商 | 必填 | 文本 | `NVIDIA` | 加速设备厂商。 |
| 型号 | 必填 | 文本 | `A100` | 加速卡型号。 |
| 资源名称 | 必填 | 文本 | `nvidia.com/gpu` | Kubernetes 资源名称。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 加速卡列表中出现新型号 | 加速卡列表中出现新型号。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 状态统计数量符合预期 | 状态统计数量符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 资源规格创建页能够选择该加速卡对 | 资源规格创建页能够选择该加速卡对应指标。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
