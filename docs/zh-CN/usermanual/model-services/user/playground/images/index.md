...
`图像生成` 用于选择图像模型、填写提示词、设置尺寸和风格，并查看生成结果。
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 图像生成或理解结果在页面展示 | 图像生成或理解结果在页面展示。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 尺寸、数量、质量参数变化后 | 尺寸、数量、质量参数变化后，结果符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 失败时页面展示请求 ID、错误码 | 失败时页面展示请求 ID、错误码或安全策略提示。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
## 常见问题
