...
镜像管理像平台里的运行环境货架，运营方把可用于 IDE、推理、训练等场景的镜像整理上架，并通过标签、仓库和同步状态控制用户能否选择。
...
| --- | --- | --- | --- | --- |
| 镜像名称 | 必填 | 文本 | `pytorch-training` | 镜像展示名称。 |
| 镜像地址 | 必填 | 文本 | `registry.example.com/ai/pytorch:2.3` | 镜像仓库地址，示例使用占位符。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 镜像出现在列表中 | 镜像出现在列表中。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 作业或模板创建页可以选择该镜像 | 作业或模板创建页可以选择该镜像。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
