...
| --- | --- | --- | --- | --- |
| 设备型号 | 必填 | 文本 | `NVIDIA A800` | 展示 GPU/NPU 或其他加速设备型号。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 设备列表展示型号、节点、利用率、 | 设备列表展示型号、节点、利用率、显存、温度和健康状态。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 异常设备能对应到节点和受影响作业 | 异常设备能对应到节点和受影响作业。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 显存和利用率趋势与作业运行窗口一 | 显存和利用率趋势与作业运行窗口一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
