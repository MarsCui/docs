...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 默认策略保存成功 | 默认策略保存成功。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 新租户或初始化流程按默认值带入 | 新租户或初始化流程按默认值带入。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 列表中目标租户额度更新 | 列表中目标租户额度更新。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 用户端创建作业时额度校验符合预期 | 用户端创建作业时额度校验符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
