...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 规则出现在列表中 | 规则出现在列表中。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 推理模板可以引用该显存规则 | 推理模板可以引用该显存规则。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 使用不同模型、精度、KV Tok | 使用不同模型、精度、KV Token 和并发组合时，推荐规格符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 用户选择过小规格时 | 用户选择过小规格时，页面能给出限制或提示。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
