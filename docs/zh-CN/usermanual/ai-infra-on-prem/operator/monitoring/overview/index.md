...
![统计概览页面](./images/monitoring-overview-browser.png)
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 总览卡片显示集群、节点、设备、作 | 总览卡片显示集群、节点、设备、作业和异常汇总。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 切换地域或时间范围后 | 切换地域或时间范围后，趋势和异常数量同步变化。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 下钻到明细页后 | 下钻到明细页后，对象范围与总览统计一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
