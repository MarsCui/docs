...
| 典型用途 | 查看各规格的额度、占用和消费明细，辅助判断资源消耗来源 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 明细页面或抽屉能打开 | 明细页面或抽屉能打开。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 记录中的规格与点击行一致 | 记录中的规格与点击行一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 消耗来源可与实例或作业对应 | 消耗来源可与实例或作业对应。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
