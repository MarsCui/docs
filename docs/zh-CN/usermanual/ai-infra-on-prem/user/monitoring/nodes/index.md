...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 节点列表展示节点名、所属集群、状 | 节点列表展示节点名、所属集群、状态和关键指标。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 指标曲线与选择的时间范围一致 | 指标曲线与选择的时间范围一致。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 异常节点能与受影响实例或作业时间 | 异常节点能与受影响实例或作业时间段对应。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
