...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 默认额度策略保存成功 | 默认额度策略保存成功。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 客户出现在列表中 | 客户出现在列表中。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 充值明细中有对应初始化记录 | 充值明细中有对应初始化记录。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 目标客户额度变化符合预期 | 目标客户额度变化符合预期。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 明细记录可追溯 | 明细记录可追溯。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
