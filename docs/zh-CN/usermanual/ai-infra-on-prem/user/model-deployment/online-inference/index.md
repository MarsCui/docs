...
| --- | --- | --- | --- | --- |
| 服务名称 | 必填 | 文本 | `qwen-service` | 在线推理服务名称。 |
| 模型 | 必填 | 下拉选择 | `qwen-7b` | 要部署的模型。 |
| 推理模板 | 必填 | 下拉选择 | `qwen-vllm-template` | 服务使用的模板。 |
| 实例数量 | 必填 | 数字 | `1` | 推理服务副本数。 |
...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 目标实例出现在列表中 | 目标实例出现在列表中。 | 未达到时检查模板、规格、镜像、端口、环境变量和实例事件 |
| 实例状态符合预期 | 实例状态符合预期。 | 未达到时检查模板、规格、镜像、端口、环境变量和实例事件 |
| 分页总数与筛选条件一致 | 分页总数与筛选条件一致。 | 未达到时检查模板、规格、镜像、端口、环境变量和实例事件 |
