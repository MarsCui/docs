...
| 检查项 | 成功表现 | 异常时处理 |
| --- | --- | --- |
| 新增桶出现在桶列表中 | 新增桶出现在桶列表中。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 搜索桶名能够定位到该桶 | 搜索桶名能够定位到该桶。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
| 进入桶详情后可以查看对象列表或上 | 进入桶详情后可以查看对象列表或上传入口。 | 未达到时回到对应页面核对权限、筛选条件和配置状态 |
